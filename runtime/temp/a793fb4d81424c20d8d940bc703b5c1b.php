<?php /*a:2:{s:68:"E:\www\adminlte\application\admin\view\interaction\messageboard.html";i:1529050433;s:48:"E:\www\adminlte\application\admin\view\base.html";i:1528962527;}*/ ?>
<!DOCTYPE html>
<!--
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-file-powerpoint-o"></i> <span>页面管理</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-folder-open"></i> <span>媒体管理</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-comments-o"></i> <span>互动管理</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
            ...
            <div class="box-body">
              ...
              <div class="direct-chat-messages">
                ...
                <div class="direct-chat-msg">
                  ...
                  <!-- /.direct-chat-info -->
                  <img class="direct-chat-img" src="/static/admin/dist/img/user1-128x128.jpg" alt="Message User Image"><!-- /.direct-chat-img -->
                ...
                <div class="direct-chat-msg right">
                  ...
                  <!-- /.direct-chat-info -->
                  <img class="direct-chat-img" src="/static/admin/dist/img/user3-128x128.jpg" alt="Message User Image"><!-- /.direct-chat-img -->
                  <div class="direct-chat-text">
              ...
              <div class="direct-chat-contacts">
                <ul class="contacts-list">
                  <li>
                    <a href="#">
                      <img class="contacts-list-img" src="/static/admin/dist/img/user1-128x128.jpg" alt="User Image">
